...
#     "config", "ros2_controllers.yaml")) as f:
...
def generate_launch_description():
    ...
    # # Combine robot description and controller parameters
    # ros2_control_params = {**moveit_config.robot_description, **controller_params}
